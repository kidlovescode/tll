...
void main() {
  runApp(new MaterialApp(home: new SelectPattern()));
}
...
class  SelectData{
  ...
  var questions = [
    "เลือกพยัญชนะที่เหมือนกับพยัญชนะที่อยู่ตรงกลาง",
    "เลือกพยัญชนะที่เหมือนกับพยัญชนะที่อยู่ตรงกลาง",
    "เลือกพยัญชนะที่เหมือนกับพยัญชนะที่อยู่ตรงกลาง",
    "เลือกพยัญชนะที่เหมือนกับพยัญชนะที่อยู่ตรงกลาง",
    "เลือกพยัญชนะที่เหมือนกับพยัญชนะที่อยู่ตรงกลาง",
  ...
  var audioQuiz = [
    "audio/sal1.m4a", "audio/sal2.m4a", "audio/sal4.m4a", "audio/sal7.m4a","audio/sal8.m4a"
  ];
...
class SelectState extends State<SelectPattern> {
  @override
             ...
             child: Column(
              children:[
               ...
               new BigCircleButton(
                  ...
                  onTap: ()=>{
                   audioapp =  new AudioPlayer().play("http://www.kidlovescode.com/gamethai/"+quiz.audioQuiz[questionNumber])


                  }
                  ,
                 iconData: Icons.satellite, textt: Text(quiz.choices[questionNumber][0],textAlign: TextAlign.center,style: new TextStyle(
                fontSize: 50.0,
                color: Colors.red,
...
class BigCircleButton extends StatelessWidget {
  ...
  final IconData iconData;
  final Text textt;
  const BigCircleButton({Key key, this.onTap, this.iconData, this.textt}) : super(key: key);
