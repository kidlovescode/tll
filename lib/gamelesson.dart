...
final List<String> imgList = [
  'http://www.kidlovescode.com/gamethai/pic/menu/w1_1.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/wt1_1.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/w1_2.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/wt1_2.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/w1_3.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/wt1_3.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/w1_4.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/wt1_4.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/w1_5.png',
  'http://www.kidlovescode.com/gamethai/pic/menu/wt1_5.png',
];
...
class CarouselDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'demo',
      home: Scaffold(
        appBar: AppBar(title: Text('หมวดการเรียนรู้คำ')),
        body: ListView(
          children: <Widget>[
