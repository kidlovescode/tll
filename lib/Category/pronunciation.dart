...
void main() {
  runApp(new MaterialApp(
    title: 'หมวดหมู่การเรียนรู้การอ่านออกเสียง',
    home: new ShoppingList(Category:
    [
      new WCategory('พยัญชนะ','images/iconw.png',false),
      new WCategory('สระ','images/iconw.png',false),
      new WCategory('ตัวสะกด','images/iconw.png',false),
      new WCategory('อักษรนำ','images/iconw.png',false),
      new WCategory('สะกดคำและพยางค์','images/iconw.png',false),
      new WCategory('คำที่มี รร','images/iconw.png',false),
      new WCategory('คำที่ไม่ออกเสียงพยัญชนะ','images/iconw.png',false),
      new WCategory('คำที่ไม่ออกเสียงสระ','images/iconw.png',false),
    ],),
  ));
}