...
void main() => runApp(new PopupScore());
...
class PopupScore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      home: new PopupScoreFul(),
    );
  }

}

class PopupScoreFul extends StatefulWidget {
  const PopupScoreFul();
  @override
  PopupScoreState createState() => new PopupScoreState();
}

class PopupScoreState extends State<PopupScoreFul> {
