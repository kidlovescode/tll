...
String kUrl = "";
void main() {
  runApp(new MaterialApp(home: new Scaffold(body: new AudioCorrect())));
}

enum PlayerState { stopped, playing, paused }

class AudioCorrect extends StatelessWidget {
  //String kUrl = "";
  String soundau ="http://www.kidlovescode.com/gamethai/audio/correct.mp3" ;
