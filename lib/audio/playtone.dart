...
String kUrl = "";
void main() {
  runApp(new MaterialApp(home: new Scaffold(body: new AudioTone("http://www.kidlovescode.com/gamethai/audio/tone/tal1_1.m4a"))));
}
...
class AudioTone  extends StatelessWidget {
  //String kUrl = "";
  String soundau;


  AudioPlayer audioPlayer;
  AudioTone( String select ){
      soundau = select ;
       turnOn();
  }
//  @override
