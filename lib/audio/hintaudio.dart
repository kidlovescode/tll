...
String kUrl = "";
void main() {
  runApp(new MaterialApp(home: new Scaffold(body: new HintAudioApp("http://www.inspireadviser.com/gamethai/audio/sal1.m4a"))));
}

enum PlayerState { stopped, playing, paused }

class HintAudioApp extends StatefulWidget {
  //String kUrl = "";
  String soundau;
  HintAudioApp(String  audio){
    soundau = audio;
    kUrl = audio;
    print(' link '+kUrl);
  ...
  @override
  _HintAudioAppState createState() => new _HintAudioAppState(soundau);
}

class _HintAudioAppState extends State<HintAudioApp> {
  Duration duration;
  Duration position;
