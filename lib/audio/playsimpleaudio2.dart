...
String kUrl = "";
void main() {
  runApp(new MaterialApp(home: new Scaffold(body: new AudioApp("http://www.kidlovescode.com/gamethai/audio/sal1.m4a"))));
}
