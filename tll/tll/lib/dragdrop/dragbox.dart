...
import 'package:tll/dragdrop/draggable_text.dart';

import 'package:tll/dragdrop/drop_target.dart';
...
class _GameViewState extends State<GameView> {
  ...
  void _onItemSelection(Matching selectedItem, int targetId) {
    ...
    setState(() {
      ...
      print ("target  "+targetId.toString()+" Selected "+selectedItem.toString());
  ...
  void _onValidate() {
    ...
    setState(() {
      ...
      pairs.forEach((index, item) {
        ...
        print ("id "+item.id.toString()+" index "+index.toString());
