...
void main() {
  runApp(new MaterialApp(
    ...
    [
      new WCategory('คำที่มีความหมายคล้าย','images/iconw.png',false),
      new WCategory('คำพ้องเสียง','images/iconw.png',false),
      new WCategory('ตำกับพยัญชนะพิเศษ','images/iconw.png',false),
      new WCategory('คำย่อ','images/iconw.png',false),
      new WCategory('คำและวรรค','images/iconw.png',false),
      new WCategory('คำต่างประเทศในภาษาไทย','images/iconw.png',false),
