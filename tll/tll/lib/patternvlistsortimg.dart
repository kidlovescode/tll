...
class _MyHomePageState extends State<MyHomePage> {
  List<ItemData> _items, _items_img;
  _MyHomePageState() {
    _items = List();
    _items_img = List();
    _items.add(ItemData("ไก่ออกลูกเป็นไข่", ValueKey(0)));
    _items.add(ItemData("แม่ไก่ฟักไข่", ValueKey(1)));
    _items.add(ItemData("ไข่แตกลูกเจี๊ยบเกิด", ValueKey(2)));
    _items.add(ItemData("ลูกเจี๊ยบเดินได้", ValueKey(3)));
    _items_img.add(ItemData("images/order1.png", ValueKey(0)));
    _items_img.add(ItemData("images/order3.png", ValueKey(1)));
    _items_img.add(ItemData("images/order2.png", ValueKey(2)));
    _items_img.add(ItemData("images/order4.png", ValueKey(3)));
